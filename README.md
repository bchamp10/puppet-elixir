...
1. [Setup - The basics of getting started with elixir](#setup)
    * [What elixir affects](#what-elixir-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with elixir](#beginning-with-elixir)
